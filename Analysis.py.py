...
if st.session_state["analyze"]:
    ...
    with c2:
        ...
        range = st.slider("Select range for count of companies",company_counts["count"].min(),company_counts["count"].min(),(company_counts["count"].min(),company_counts["count"].min()))
